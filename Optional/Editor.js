...
_DEFAULT_CAMERA.position.set( 0, 5, 15 );
...
function Editor() {
	...
	this.directionalLight1.position.set( 15, 15, 15 );
	this.directionalLight1.name = 'DirectionalLight';
	...
	this.addObject( this.directionalLight1 );
